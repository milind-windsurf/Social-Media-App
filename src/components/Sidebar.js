...
export const Sidebar = () => {
   ...
   */
  const renderIcon = (iconName, active = false) => {
    ...
    <div className="w-64 h-screen bg-white border-r border-gray-200 p-4 fixed left-0 top-0">
      ...
      <div className="mb-8">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl heading-2 text-blue-500 ml-2 tracking-wider">SurfSocial</h1>
        </div>
      </div>
      ...
      <div className="absolute bottom-4 left-4 right-4">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="font-medium text-gray-900 truncate font-display" data-component-name="Sidebar">Your Name</p>
            <p className="text-sm text-gray-500 truncate font-mono" data-component-name="Sidebar">@yourhandle</p>
          </div>
        </div>
