...
export const PostsProvider = ({ children }: PostsProviderProps): JSX.Element => {
  ...
  const [posts, setPosts] = useState<Post[]>([
    ...
    },
    {
      ...
      updatedAt: new Date('2024-01-15T13:10:00'),
      likes: 204,
      retweets: 87,
      replies: 65
    },
    {
      ...
      updatedAt: new Date('2024-01-15T14:05:00'),
      likes: 176,
      retweets: 93,
      replies: 27
    },
    ...
    },
    {
      ...
      updatedAt: new Date('2024-01-15T19:15:00'),
      likes: 134,
      retweets: 56,
      replies: 29
    },
    ...
    },
    {
      ...
      updatedAt: new Date('2024-01-15T20:45:00'),
      likes: 189,
      retweets: 67,
      replies: 38
    },
    ...
    },
    {
      ...
      updatedAt: new Date('2024-01-15T22:15:00'),
      likes: 76,
      retweets: 23,
      replies: 17
    },
    {
      ...
      createdAt: new Date('2024-01-15T23:00:00'),
      updatedAt: new Date('2024-01-15T23:00:00'),
      likes: 245,
      retweets: 98,
      replies: 57
    },
    {
      ...
      createdAt: new Date('2024-01-15T23:45:00'),
      updatedAt: new Date('2024-01-15T23:45:00'),
      likes: 312,
      retweets: 143,
      replies: 64
    }
   ...
   * @param {string} postId - The ID of the post to retweet
   */
  const retweetPost = (postId: string): void => {
    setPosts(prevPosts =>
      prevPosts.map(post =>
        post.id === postId
