 ...
 * @returns {Object} Posts context value with posts and functions to manage them
 */
...
export const PostsProvider = ({ children }) => {
  ...
  const [posts, setPosts] = useState([
    ...
    },
    {
      ...
      content: 'Just launched my portfolio site built with Next.js and Tailwind! Check it out at olivia-dev.vercel.app and let me know what you think! 💻✨',
    ...
    },
    {
      ...
      content: 'Hot take: CSS Grid is better than Flexbox for complex layouts. Fight me. 😤',
    ...
    },
    {
      ...
      content: 'Debugging for 3 hours only to find I forgot a closing bracket. This is fine. 🙃 #DeveloperLife',
